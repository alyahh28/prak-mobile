...
import androidx.recyclerview.widget.GridLayoutManager // Pastikan import ini ditambahkan jika belum ada
import com.example.alyah_apps.R
import com.example.alyah_apps.databinding.FragmentHomeBinding
import com.example.alyah_apps.databinding.FragmentTabCBinding
...
class TabCFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // 1. Menginisialisasi View Binding dengan benar
        _binding = FragmentTabCBinding.inflate(inflater, container, false)

        // 2. Mengembalikan root view dari binding (bukan melakukan inflate manual lagi)
        return binding.root
    }
